    ...
    return (
        <div className="w-full h-full opacity-40">
            <Canvas camera={{ position: [0, 0, 5], fov: 45 }}>
                ...
                <ShaderPlane position={[-1.5, 0.5, 0]} color1="#D4AF37" color2="#B38B2D" />
                <ShaderPlane position={[1.5, -0.5, -1]} color1="#F2D47E" color2="#D4AF37" />

                <EnergyRing radius={2.5} position={[0, 0, 0]} />
                <EnergyRing radius={3.8} position={[0, 0, -1]} />
            </Canvas>
        </div>
    );
}
